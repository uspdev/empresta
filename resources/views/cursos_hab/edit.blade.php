                ...
                <div class="form-group">
                    ...
                    <select name="curso_hab" class="curso_hab form-control" required>
                        ...
                        @foreach ($cursos_hab as $curso_hab)
                            <option value='{"codcur": {{$curso_hab['codcur']}}, "codhab": {{$curso_hab['codhab']}}, "nomcur": "{{$curso_hab['nomcur']}}", "nomhab": "{{$curso_hab['nomhab']}}", "perhab": "{{$curso_hab['perhab']}}"}' {{$curso_hab['codcur'] == $curso->codcur && $curso_hab['codhab'] == $curso->codhab ? 'selected': ''}}>{{$curso_hab['codcur']}} / {{$curso_hab['codhab']}} / {{$curso_hab['nomcur']}} / {{$curso_hab['nomhab']}} / {{$curso_hab['perhab']}}</option>
                        @endforeach
                    </select>
